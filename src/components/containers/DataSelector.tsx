...
export const SelectData: React.VFC<SelectDataProps> = (props) => {
  ...
  return (
    <div className="component-select-student-data-wrapper">
      ...
      <button onClick={handleBackToTop} className="btn retry-btn btn__typeC">
        前のページに戻る
      </button>
      <div ref={selectorContainer} className="grade-selector">
        <button onClick={handleStudentList} className="btn" id="middle-1">
          中学１年生
        </button>
        <button onClick={handleStudentList} className="btn" id="middle-2">
          中学２年生
        </button>
        <button onClick={handleStudentList} className="btn" id="middle-3">
          中学３年生
        </button>
        <button onClick={handleStudentList} className="btn" id="high-1">
          高校１年生
        </button>
        <button onClick={handleStudentList} className="btn" id="high-2">
          高校２年生
        </button>
        <button onClick={handleStudentList} className="btn" id="high-3">
          高校３年生
        </button>
        <button onClick={handleStudentList} className="btn" id="elementary-1">
          小学１年生
        </button>
        <button onClick={handleStudentList} className="btn" id="elementary-2">
          小学２年生
        </button>
        <button onClick={handleStudentList} className="btn" id="elementary-3">
          小学３年生
        </button>
        <button onClick={handleStudentList} className="btn" id="elementary-4">
          小学４年生
        </button>
        <button onClick={handleStudentList} className="btn" id="elementary-5">
          小学５年生
        </button>
        <button onClick={handleStudentList} className="btn" id="elementary-6">
          小学６年生
        </button>
        <button onClick={handleOthers} className="btn" id="others">
          その他関係者
        </button>
      </div>
      {handleComponent()}
